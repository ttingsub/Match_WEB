...
<body>
	<div class="wrap_content">
		...
		<form action="reply_insert.no" method="post"
			...
			<table>
				...
				<tr>
					...
					<td><textarea name='content' title='내용' class="chk"></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="left"><label> <input type="file"
							name='file' id='attach-file' /> <img alt="x"
		...
		<div class="btnset">
			...
			<a class="btn-fill"
				...
				class="btn-fill" href="list.no">취소 </a>
