...
<footer style="border-top: 1px solid #ccc; padding: 15px 0;
    ...
    <div>
        	<a href="https://play.google.com/store/apps" target="_blank"><img alt="" src="imgs/momo-app.png2.png" style="width: 400px; height: 150px; float: right; margin-top: -20px;"></a>
        </div>
  ...
  <div class="footer-container" style="text-align: left;">
    <div class="footer-top">
      ...
      <ul class="footer-list">
        <li class="footer-list-item"><a class="link-highlight" href="/trust" 
        style="float: left;">우리 모두의 모임</a></li>
        <li class="footer-list-item"><a class="link-highlight" 
        href="https://cs.kr.karrotmarket.com/wv/faqs"
        style="float: left; margin-left: 100px;">자주 묻는 질문</a></li>
      </ul>
      <ul class="footer-list">
        <li class="footer-list-item"><a target="_blank" href="http://team.daangn.com"
        style="float: left; margin-left: 100px;">회사 소개</a></li>
        <li class="footer-list-item"><a target="_blank" class="link-highlight" href="https://ad.daangn.com/"
        style="float: left; margin-left: 100px;">광고주센터</a></li>
        <li class="footer-list-item">
          <a target="_blank" class="ga-click" data-event-category="town_link_from" data-event-action="index_base" data-event-label="footer_town" href="https://town.daangn.com"
          style="margin-left: 100px;">동네가게</a>
        </li>
      </ul>
      <ul class="footer-list policy">
        <li class="footer-list-item"><a target="_blank" href="https://policy.daangn.com/terms.html"
        style="float: left; margin-left: 100px;">이용약관</a></li>
        <li class="footer-list-item"><a target="_blank" href="https://policy.daangn.com/privacy.html"
        style="float: left; margin-left: 100px;">개인정보처리방침</a></li>
        <li class="footer-list-item"><a target="_blank" href="https://policy.daangn.com/location.html"
        style="margin-left: 100px;">위치기반서비스 이용약관</a></li>
      </ul>
    </div>
    <div class="footer-bottom">
      <div id="copyright">
        <ul class="copyright-list">
          <li class="copyright-list-item">고객문의 <a href="mailto:cs@daangnservice.com">wmffprtk66@naver.com</a></li>
          <li class="copyright-list-item">제휴문의 <a href="mailto:contact@daangn.com">wmffprtk66@naver.com</a></li>
        </ul>
        <ul class="copyright-list">
          <li class="copyright-list-item">지역광고 <a href="mailto:ad@daangn.com">wmffprtk66@naver.com</a></li>
          <li class="copyright-list-item">PR문의 <a href="mailto:pr@daangn.com">wmffprtk66@naver.com</a></li>
        </ul>
