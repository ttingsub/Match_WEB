...
public class PageVO {
	...
	public void setTotalList(int totalList) {
		...
		//현재 페이지에 따라서 보여질 글의 시작/끝목록번호가 결정된다.
		//각 페이지의 끝 목록번호 : 총목록수 - (페이지번호-1) * 페이지당 보여질 목록수
		
		endList = totalList - (curPage - 1) * pageList;
		//각페이지의 시작 목록번호 : 끝 목록번호 - (페이지당 보여질 목록수-1)
		...
		//각 블럭의 끝 페이지 번호 : 블럭번호 * 블럭당 보여질 페이지수
