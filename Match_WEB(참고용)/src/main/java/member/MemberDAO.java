...
public class MemberDAO implements MemberService {
	...
	public boolean member_social_id(MemberVO vo) {
		return (Integer)sql.selectOne("member.mapper.social_id", vo)==0 ? false : true;
	}

	@Override
	public boolean member_social_insert(MemberVO vo) {
		return sql.insert("member.mapper.social_insert", vo)==1 ? true : false;
	}

	@Override
	public boolean member_social_update(MemberVO vo) {
		return sql.update("member.mapper.social_update", vo) == 1 ? true : false;
	}
